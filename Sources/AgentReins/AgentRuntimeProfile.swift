...
enum AgentRuntimeProfileRegistry {
    ...
    private static let codex = AgentRuntimeProfile(
        ...
        rules: [
            ...
            rule("codex-node-repl", ["node_repl"], "Code Runtime", .toolRuntime,
                 "Executes JavaScript operations requested by an active Codex tool session.",
                 "terminal", ["Code execution", "Tool input", "Filesystem and network access"]),
